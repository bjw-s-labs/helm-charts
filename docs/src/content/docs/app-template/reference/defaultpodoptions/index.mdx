...
| `automountServiceAccountToken` | `boolean` | No | `true` | Set to true to automatically mount the service account to... |
...
| `labels` | `object / null` | No | - | Annotations to set on the item. |
