...
| `annotations` | `object / null` | No | - | Set additional global annotations. |
...
| `labels` | `object / null` | No | - | Set additional global labels. |
...
| [`templateEvaluation`](./templateevaluation/) | `object` | No | - | Configure global string template evaluation. |
